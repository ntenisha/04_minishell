...
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2022/10/06 13:50:17 by ntenisha          #+#    #+#             */
/*   Updated: 2022/10/19 21:20:08 by ntenisha         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
int			redirectionsnormtree(t_list *next, t_tree *node, t_list *end,
				t_list **parsresult);
...
void		ft_varmerging(t_list *list, char **str, int *wild,
				t_befexec **head);
